...
VALUES 
    ((SELECT id FROM "USER" WHERE email = 'wXlTq@hexschooltest.io'), (SELECT id FROM "COURSE" WHERE name = '重訓基礎課'), '2024-11-24 16:00:00', '即將授課'),
    ((SELECT id FROM "USER" WHERE email = 'richman@hexschooltest.io'), (SELECT id FROM "COURSE" WHERE name = '重訓基礎課'), '2024-11-24 16:00:00', '即將授課');
...
WHERE user_id = (SELECT id FROM "USER" WHERE email = 'wXlTq@hexschooltest.io') AND course_id = (SELECT id FROM "COURSE" WHERE name = '重訓基礎課');
...
WHERE user_id = (SELECT id FROM "USER" WHERE email = 'wXlTq@hexschooltest.io') AND status = '上課中';
...
from "CREDIT_PURCHASE"
where "CREDIT_PURCHASE".purchase_at >= '2024-11-01 00:00:00' and "CREDIT_PURCHASE".created_at <= '2024-11-30 23:59:59';
